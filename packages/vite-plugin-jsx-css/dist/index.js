...
function repushPlugin(plugins, pluginName, pluginNames) {
...
export default function jsxCss() {
    ...
    return {
        ...
        async transform(code, file) {
            ...
            if (result.css !== "")
                styleMap.set(hashedFileName, result.css);
        ...
        configResolved(config) {
            repushPlugin(config.plugins, PLUGIN_NAME, ["solid"]);
        },
    };
}
